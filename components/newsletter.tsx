    ...
    <section className="pb-section">
      <div className="mx-auto max-w-container px-gutter">
        <div className="bg-level-1 border border-border-subtle rounded-lg px-8 md:px-20 py-14 md:py-16 text-center">
          <h2 className="font-display font-bold text-[28px] md:text-headline-lg text-white tracking-[-0.02em] mb-4">
            Stay in the Loop
          </h2>
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="flex items-center gap-2 max-w-[380px] mx-auto">
              <input
                ...
                required
                className="flex-1 min-w-0 bg-level-0 border border-border-mid rounded-full px-5 py-2.5 font-body text-body-md text-on-surface placeholder:text-zinc-muted/50 focus:outline-none focus:border-white transition-colors duration-150"
              />
              <button
                type="submit"
